...
func main() {
	...
	*/
	...
	// Кароч, break и continue работают только на циклы внутри которого они находятся. А что если нужно выйти прям сразу и из верхнего? Для этого есть тема под названием outer
...
outer:
	...
	// В большинстве случаев следует применять оператор for-range, если эти самые случаи подразумевают обход коллекций
}
